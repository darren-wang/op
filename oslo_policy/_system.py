...
class IsolationRules(object):
    def __init__(self, conf):
        ...
        # region
            "list_regions": "",
            "get_region": "",
            "create_region": "rule:admin_domain",
            "update_region": "rule:admin_domain",
            "delete_region": "rule:admin_domain",
        # service
            "list_services": "",
            "get_service": "",
            "create_service": "rule:admin_domain",
            "update_service": "rule:admin_domain",
            "delete_service": "rule:admin_domain",
        # endpoint
            "get_endpoint": "",
            "list_endpoints": "",
            "create_endpoint": "rule:admin_domain",
            "update_endpoint": "rule:admin_domain",
            "delete_endpoint": "rule:admin_domain",
        # domain
            "list_domains": "scope:domain and scope_id:" + conf.oslo_policy.admin_domain_id,
            "create_domain": "rule:admin_domain",
            "delete_domain": "rule:admin_domain",
            "get_domain": "scope:domain and scope_id:%(target.domain.id)s",
            "update_domain": "scope:domain and scope_id:%(target.domain.id)s",
        # project
            "list_projects": "scope:domain and scope_id:%(domain_id)s",
            "list_user_projects": "user_id:%(user_id)s or (scope:domain and scope_id:%(domain_id)s)",
            "create_project": "scope:domain and scope_id:%(project.domain_id)s",
