...
class BaseCheck(object):
    ...
    @abc.abstractmethod
    def __call__(self, target, cred, rule_dict):
...
class NotCheck(BaseCheck):
    ...
    def __call__(self, target, cred, rule_dict):
        ...
        return not self.rule(target, cred, rule_dict)
...
class AndCheck(BaseCheck):
    ...
    def __call__(self, target, cred, rule_dict):
        ...
        for rule in self.rules:
            if not rule(target, cred, rule_dict):
                return False
...
class RuleCheck(Check):
    ...
    def __call__(self, target, creds, rule_dict):
        try:
            return rule_dict[self.match](target, creds, rule_dict)
        except KeyError:
